...
const AboutMe = () => {
    return (
        <div id="about-me">
            <TitleSection title={'about-me'} width={500} hideMore={true} />
            <div className="flex gap-2 justify-between">
                <div className="left w-[515px] mt-5 flex items-center leading-[28px] flex-wrap">
                    ...
                    <div className="transition duration-300 hover:text-[var(--color-menu-violet)] hover:border-[var(--color-menu-violet)] cursor-pointer border-[1px] p-[6px] text-white inline-block">{'Read more ->'}</div>
                </div>
                <div className="right">
